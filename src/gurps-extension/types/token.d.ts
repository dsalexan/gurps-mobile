...
declare module "gurps/module/token" {
  export = class GurpsToken extends Token {
    static overrideRefresh: boolean
    static listen(): void
    static ready(): void
    /**
     ...
     * @param {*} options
     */
    override toggleEffect(effect: any, options: any): Promise<boolean>
